...
for jj in range(len(args.ddir)) :
	...
	if args.offdiagratio :
		if args.rew :
			print "Not implemented yet. exiting."
			sys.exit(1)
		else :
			selfeobj.getplotiwoffdiagratio_lc(axnow, dat , basis, nbasis, chdatoffd ,hobj , args , "", T=T , obj=obj )
	elif args.offdiag :
		if args.rew :
			selfeobj.getplotselfwoffdiag( axnow, dat , basis, nbasis, chdatoffd ,hobj , args , T=T )
		else :
			selfeobj.getplotiwoffdiag_lc(axnow, dat , basis, nbasis, chdatoffd ,hobj , args , "", T=T , obj=obj )
	else :
		if args.rew :
			selfeobj.getplotw(axnow, dat , basis, nbasis, chdat ,hobj , args , laboverw=leglabel, dashes=dashpt , T=T , realpart=args.realpart , obj=obj )
		else :
			selfeobj.getplotiw_lc(axnow, dat , basis, nbasis, chdat ,hobj , args , "" , laboverw=leglabel, dashes=dashpt , logplot=logplot , T=T , obj=obj )
